  ...
  data () {
    return {
      ...
      steps: {
        ...
        12: () => { this.visibleaddedSeconds = true; this.addedSeconds > 0 ? this.taunt('Let\'s see how many times you cheated', `Oh not bad, ${this.addedSeconds} clicks !`) : this.taunt('You didn\'t cheat once !', 'Well, you can add seconds', 'by clicking the time wasted', 'top left') },
